...
/*package*/ class Parent_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new childrenListHandler_vx0ep_b1a(myNode, getEditorContext());
  ...
  private static class childrenListHandler_vx0ep_b1a extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public childrenListHandler_vx0ep_b1a(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(childrenListHandler_vx0ep_b1a.this.getNode(), LINKS.children$aH20));
      try {
  ...
  private static final class LINKS {
    /*package*/ static final SContainmentLink children$aH20 = MetaAdapterFactory.getContainmentLink(0x7a5361d88b2b4f3aL, 0xa89a5c606c9b345bL, 0x58025e95ca9c6820L, 0x58025e95ca9c682cL, "children");
  }
}
